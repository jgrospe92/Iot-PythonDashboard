...
# Initial idea for how to turn on fan with the email reply of YES
# obviously below won't work, need to either use it with check_email to have body content and have the fan componenent in the gauge.py
# def fan_to_turn():
#     if body == "YES":
